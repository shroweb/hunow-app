...
export default function HomeScreen() {
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: NAV }}>
      ...
      >
        {/* ── Header ────────────────────────────────────── */}
        <View style={{ paddingHorizontal: 20, paddingTop: 20, paddingBottom: 16, flexDirection: "row", alignItems: "flex-start", justifyContent: "space-between" }}>
          <View style={{ justifyContent: "flex-start" }}>
            <Image
              source={{ uri: BRAND_LOGO_URL }}
              style={{ width: 112, height: 52, marginLeft: -18, alignSelf: "flex-start" }}
              resizeMode="contain"
            />
          </View>
          <View style={{ alignItems: "flex-end", paddingTop: 8, flex: 1 }}>
        ...
        <TouchableOpacity
          ...
          style={{
            marginHorizontal: 20, marginTop: 10, backgroundColor: SURFACE,
                    ...
                    <View style={{ padding: 14 }}>
                        {offer.featured ? (
                          ...
                          <View style={{ alignSelf: "flex-start", backgroundColor: YELLOW + "22", borderRadius: 999, paddingHorizontal: 9, paddingVertical: 5, marginBottom: 8 }}>
                            <Text style={{ color: NAV, fontWeight: "800", fontSize: 10, letterSpacing: 0.6 }}>NEAR YOU</Text>
                          </View>
                        )}
